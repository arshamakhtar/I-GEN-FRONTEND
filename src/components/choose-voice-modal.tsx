...
const iGenLibraryVoice: Voice[] = [
  {
    ...
    flag: "🇺🇸",
    audioSrc:
      "https://public-i-gen.s3.eu-north-1.amazonaws.com/samples/voices/1.wav",
  ...
  },
  {
    ...
    flag: "🇺🇸",
    audioSrc:
      "https://public-i-gen.s3.eu-north-1.amazonaws.com/samples/voices/2.wav",
    s3Key: "samples/voices/2.wav",
  },
  {
    id: "v3",
    name: "Walter White",
    tags: ["Direct", "Aggressive"],
    accent: "American",
    flag: "🇺🇸",
    audioSrc:
      "https://public-i-gen.s3.eu-north-1.amazonaws.com/samples/voices/njlp1-xtqac.wav",
    s3Key: "samples/voices/njlp1-xtqac.wav",
  },
];
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl">
        ...
        <Tabs defaultValue="igen-library">
          <TabsList>
            <TabsTrigger value="my-voices">My Voices</TabsTrigger>
            <TabsTrigger value="igen-library">I-Gen Library</TabsTrigger>
          </TabsList>
